...
if (isset($_POST["spot_id"])){
  ...
  $delete_id = $_POST["spot_id"];

  $sql = "DELETE FROM `parking space`
          WHERE `Spot Number` = '$delete_id' and `userName` ='". $Username2. "'";

  mysqli_query($dbc, $sql);
  header('location: view.php?DeleteParkingSpace=Success');
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <h3>Parking Spots</h3>
                        <!--form starts here-->
                        <form action="deleteParkingSpot.php" method='post'>
							<div class="row">	
