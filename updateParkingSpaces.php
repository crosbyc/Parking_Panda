 ...
 // if (isset($_POST['category'])){
  ...
  if ($result->num_rows > 0) {
      ...
      while($row = $result->fetch_assoc()) {
            echo '<form class="form" action="updateParkingSpace.php" method="POST">
              Spot Number: <br> <input type="text" name="Spot_Number" value="'.$row["Spot Number"].'" maxlength="255" readonly> <br>

              Location: <br> <input type="text" name="Location" value="'.$row["Location"].'"  maxlength="255" required> <br>
              Type: <br> <input type="text" name="Type" value="'.$row["Type"].'"  maxlength="255"> <br>
              Building: <br> <input type="text" name="Building" value="'.$row["Building"].'"  maxlength="255"> <br>
